        ...
        <div class="card card-default color-palette-bo">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#email" role="tab"
                            aria-controls="email" aria-selected="false"><?=trans('email_setting')?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#reCAPTCHA" role="tab"
                            aria-controls="reCAPTCHA" aria-selected="false"><?=trans('google_setting')?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="main">
                        <div class="form-group">
                            ...
                            <p><img src="<?=$general_settings['favicon'];?>" class="favicon"
                        ...
                        <div class="form-group">
                            ...
                            <p><img src="<?=$general_settings['logo']?>" class="logo" width="150"></p>
                            <?php endif;?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="timezone" placeholder="Enter your timezone"
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="copyright" placeholder="Enter your copyright"
                    ...
                    <div role="tabpanel" class="tab-pane" id="email">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="smtp_user" placeholder="SMTP Email"
                                value="<?php echo html_escape($general_settings['smtp_user']); ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="smtp_pass" placeholder="SMTP Password"
                                value="<?php echo html_escape($general_settings['smtp_pass']); ?>">
                        </div>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="social">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="facebook_link" placeholder=""
                                value="<?php echo html_escape($general_settings['facebook_link']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Twitter</label>
                            <input type="text" class="form-control" name="twitter_link" placeholder=""
                                value="<?php echo html_escape($general_settings['twitter_link']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Google Plus</label>
                            <input type="text" class="form-control" name="google_link" placeholder=""
                                value="<?php echo html_escape($general_settings['google_link']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Youtube</label>
                            <input type="text" class="form-control" name="youtube_link" placeholder=""
                                value="<?php echo html_escape($general_settings['youtube_link']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">LinkedIn</label>
                            <input type="text" class="form-control" name="linkedin_link" placeholder=""
                                value="<?php echo html_escape($general_settings['linkedin_link']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Instagram</label>
                            <input type="text" class="form-control" name="instagram_link" placeholder=""
                                value="<?php echo html_escape($general_settings['instagram_link']); ?>">
                        </div>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="reCAPTCHA">
                        ...
                        <div class="form-group">
                            ...
                            <a href="https://developers.google.com/recaptcha/docs/language"
                                target="_blank">https://developers.google.com/recaptcha/docs/language</a>
                        </div>
                    </div>
