          ...
          <div class="card card-default">
              <div class="card-header">
                  ...
                  <div class="d-inline-block float-right">
                      <a href="<?=base_url('admin/admin_roles/sub_module/' . $module['parent']);?>"
                          class="btn btn-success"><i class="fa fa-list"></i> Sub Module List</a>
                  </div>
              </div>
...
?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="text" name="sub_module_name" value="<?=$module['name'];?>" class="form-control"
                              id="sub_module_name" placeholder="Enter sub module name">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="text" name="operation" value="<?=$module['link'];?>" class="form-control"
                              id="operation" placeholder="eg. about_us">
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <div class="col-md-12">
                          <input type="submit" name="submit" value="Update Sub Module"
