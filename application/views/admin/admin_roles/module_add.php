          ...
          <div class="card card-default">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="text" name="controller_name" class="form-control" id="controller_name"
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="text" name="fa_icon" class="form-control" id="fa_icon"
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="text" name="operation" class="form-control" id="operation"
                              placeholder="eg. add|edit|delete">
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <div class="col-md-12">
                          <input type="submit" name="submit" value="<?=trans('add_module')?>"
