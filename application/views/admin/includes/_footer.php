...
<script src="<?=base_url()?>assets/plugins/jquery-validation/custom.jquery.validation.js"></script>
<script>
...
<!--
<script src="<?=base_url()?>assets/dist/js/plugins/translate/langConvert.js"></script>
<script src="<?=base_url()?>assets/dist/js/plugins/translate/google_jsapi.js"></script> -->
<!-- bootstrap-duallist -->
...
$(function() {
    ...
    setTimeout(() => {
        $('input[name="username"],input[name="password"]').map(function(e) {
