        ...
        <div class="card card-default color-palette-bo">
            <div class="card-header">
                ...
                <div class="d-inline-block float-right">
                    <a href="<?=base_url('admin/profile/change_pwd');?>" class="btn btn-success"><i
            ...
            <div class="card-body">
                ...
                <?php echo form_open(base_url('admin/profile'), ['class' => "form-horizontal", 'id' => 'frm-profile']) ?>
...
$(function() {
    $('#frm-profile').validate({
        rules: {
            username: {
                required: true,
                adminUserExist: [<?=$this->session->userdata('admin_id')?>],
            },
            firstname: {
                required: true,
            },
