        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <div class="form-group has-feedback">
                    <input type="text" name="username" readonly id="name" value="<?=old("username");?>"
                ...
                <div class="form-group has-feedback">
                    <input type="password" readonly name="confirm_password" id="confirm_password" class="form-control"
